...
})(
  {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      _context.next = 2;
                      return (0, _dataurl.Conversion)();

                    case 2:
                      _yield$Conversion = _context.sent;
    ...
    eIhA: [
      function (require, module, exports) {
        ...
        var PREVIEW = document.getElementById("preview__src"); // const IMAGE_DATA = document.getElementById("image");
        ...
        var el = document.getElementById("saveCh");

        if (el) {
          el.addEventListener("click", _post.postForm);
        } // document.getElementById("saveCh").addEventListener("click",);
      },
      { "regenerator-runtime": "KA2S", "./post.js": "DCbj" },
    ],
  },
  {},
  ["eIhA"],
...
//# sourceMappingURL=create1.1ae0acd8.js.map
